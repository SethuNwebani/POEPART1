...
public class LoginTest {
    ...
    public void testValidPhoneNumber() {
        Registration.java.Login login = new Registration.java.Login("Kyle", "Marowa", "ch&&sec@ke99!", "+27838968976", "kyl_1");
    ...
    public void testValidPassword() {
        ...
        Registration.java.Login login = new Registration.java.Login("Kyle", "Marowa", validPassword, "+27838968976", "kyl_1");
